const VERSES = [
  { id: "gen11", ref: "Genesis 1:1", text: "In the beginning God created the heavens and the earth." },
  { id: "ps231", ref: "Psalm 23:1", text: "The Lord is my shepherd; I shall not want." },
  { id: "ps4610", ref: "Psalm 46:10", text: "Be still, and know that I am God." },
  { id: "ps563", ref: "Psalm 56:3", text: "When I am afraid, I put my trust in you." },
  { id: "ps1186", ref: "Psalm 118:6", text: "The Lord is on my side; I will not fear." },
  { id: "ps119105", ref: "Psalm 119:105", text: "Your word is a lamp to my feet and a light to my path." },
  { id: "ps1361", ref: "Psalm 136:1", text: "Give thanks to the Lord, for he is good." },
  { id: "prov35", ref: "Proverbs 3:5", text: "Trust in the Lord with all your heart." },
  { id: "josh19", ref: "Joshua 1:9", text: "Be strong and courageous. Do not be afraid." },
  { id: "isa4110", ref: "Isaiah 41:10", text: "Fear not, for I am with you." },
  { id: "mt514", ref: "Matthew 5:14", text: "You are the light of the world." },
  { id: "mt1914", ref: "Matthew 19:14", text: "Let the little children come to me." },
  { id: "lk631", ref: "Luke 6:31", text: "Do to others as you would have them do to you." },
  { id: "jn316", ref: "John 3:16", text: "For God so loved the world that he gave his one and only Son." },
  { id: "jn1334", ref: "John 13:34", text: "Love one another as I have loved you." },
  { id: "phil413", ref: "Philippians 4:13", text: "I can do all things through Christ who strengthens me." },
  { id: "eph432", ref: "Ephesians 4:32", text: "Be kind to one another, forgiving one another." },
  { id: "rom831", ref: "Romans 8:31", text: "If God is for us, who can be against us?" },
...
const LEVELS = {
  ...
  3: { pairs: 6, peek: 0, hints: 2, cols: 4, label: "Keepers of the Word" },
...
document.getElementById("playAgain").addEventListener("click", () => startGame(state.level));
document.getElementById("winHome").addEventListener("click", goHome);
